...
public abstract class BaseMapper<T extends BaseEntity, ID extends Serializable> extends SqlSessionDaoSupport
    ...
    private static final String SQL_SAVE = "save";
    ...
    private static final String SQL_FIND_PAGE_BY = "findPageBy";
    private static final String SQL_FIND_LIST_BY = "findListBy";
    private static final String SQL_GET_COUNT_BY = "getCountBy";
    ...
    */
    public Integer deleteByIds(ID[] ids) {
        return this.getSqlSession().delete(
                getSqlName(SQL_DELETE_BY_IDS), ids);
    }
    ...
    */
    public Integer deleteById(ID id) {
        return this.getSqlSession().delete(
                getSqlName(SQL_DELETE_BY_ID), id);
    }
...
// paramMap.put("param", param);
        return (Integer) this.getSqlSession().selectOne(
                getSqlName(SQL_GET_COUNT_BY), paramMap);
    }
...
// paramMap.put("dir", null);
        ...
        List<T> lst = this.getSqlSession().selectList(
                getSqlName(SQL_FIND_LIST_BY), paramMap);
        return lst;
    }
